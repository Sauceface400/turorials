...
label1.config(font=("halvetica", 10))
canvas1.create_window(100, 100, window=label1)

label2 = tk.Label(root,text="type value 2: ")
label2.config(font=("halvetica",10))
...
def add():
    ...
    label4 = tk.Label(root,text=float(v1)+float(v2),font=("halvetica",10,"bold"),bg="white")
    canvas1.create_window(210,240,window=label4)

buttonAdd = tk.Button(text="+",command=add,bg="green",fg="white",font=("halvetica",9,"bold"),width=5)
...
def sub():
    ...
    label5 = tk.Label(root,text=float(v1)-float(v2),font=("halvetica",10,"bold"),bg="white")
    canvas1.create_window(210,240,window=label5)

buttonSub = tk.Button(text="-",command=sub,bg="green",fg="white",font=("halvetica",9,"bold"),width=5)
...
def mul():
    ...
    label6 = tk.Label(root,text=float(v1)*float(v2),font=("halvetica",10,"bold"),bg="white")
    canvas1.create_window(210,240,window=label6)

buttonMul = tk.Button(text="X",command=mul,bg="green",fg="white",font=("halvetica",9,"bold"),width=5)
...
def div():
    ...
    label7 = tk.Label(root,text=float(v1)/float(v2),font=("halvetica",10,"bold"),bg="white")
    canvas1.create_window(210,240,window=label7)

buttonDiv = tk.Button(text="/",command=div,bg="green",fg="white",font=("halvetica",9,"bold"),width=5)
